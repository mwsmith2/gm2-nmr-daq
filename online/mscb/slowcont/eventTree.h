...
// Mon Mar 17 19:52:44 2014 by ROOT version 5.34/09
// from TTree EventTree/Temperature readings
// found on file: tempTreeSteel.root
//////////////////////////////////////////////////////////
...
public :
 ...
 //TTemps          *Event;
   ...
   TBranch        *b_Event_p9val;   //!
   TBranch        *b_Event_p10val;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tempTreeSteel.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("tempTree_20_10__17_3_2014.root");//JG: tempTree_20_10__17_3_2014.root = run 31
					     //tempTreeSteel.root = run 30
      }
...
void eventTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("p9val", &p9val, &b_Event_p9val);
   fChain->SetBranchAddress("p10val", &p10val, &b_Event_p10val);
   Notify();
}
