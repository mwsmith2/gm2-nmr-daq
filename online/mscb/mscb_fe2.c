...
char *frontend_name = "SC Frontend 2";
...
//temperature  
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+0, "Temperature 1", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+1, "Temperature 2", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+2, "Temperature 3", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+3, "Temperature 4", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+4, "Temperature 5", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+5, "Temperature 6", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+6, "Temperature 7", 0.01);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, TempSlot*8+7, "Temperature 8", 0.01);
  
  //capacitec
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, ADCSlot*8+0, "Outer Lower", 0.001);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, ADCSlot*8+1, "Inner Upper", 0.001);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, ADCSlot*8+2, "Inner Lower", 0.001);
  mscb_define("mscb174", "Environment2", "SCS2002", mscb_driver, 0x1, ADCSlot*8+3, "Outer Upper", 0.001);
...
INT read_periodic_event(char *pevent, INT off){
  ...
  db_find_key(hDB, 0, "/Equipment/Environment2/Variables/Input", &hkey);
  // return temp
  size = sizeof(temp1);
