...
Name:   test_diagnostics.cxx
Author: Matthias W. Smith
Email:  mwsmith2@uw.edu

About:  A frontend that spits out example dianostic info to test
       my online view.
...
INT frontend_init() 
{
  ...
  conf_file += std::string("fe_shim_platform.json");
...
INT read_trigger_event(char *pevent, INT off)
{
  ...
  // Fake the health plot
  sprintf(bk_name, "DGFD");
  bk_create(pevent, bk_name, TID_BOOL, &pbool);
