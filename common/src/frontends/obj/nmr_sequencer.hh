#ifndef GM2_FIELD_CORE_INCLUDE_NMR_SEQUENCER_HH_
#define GM2_FIELD_CORE_INCLUDE_NMR_SEQUENCER_HH_
...
class NmrSequencer: public daq::EventManagerBase {

public:

  //ctor
  NmrSequencer(int num_probes);
  NmrSequencer(std::string conf_file, int num_probes);
...
private:
  ...
  const std::string name_ = "NmrSequencer";
