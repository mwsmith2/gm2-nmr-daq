...
int NmrSequencer::BeginOfRun()
{
  ...
  switch (bid) {
    case 'a':
      ...
      nmr_pulser_trg_ = new daq::DioTriggerBoard(0x0, daq::BOARD_A, port);
      break;

    case 'b':
      LogDebug("setting NMR pulser trigger on dio board B, port %i", port);
      nmr_pulser_trg_ = new daq::DioTriggerBoard(0x0, daq::BOARD_B, port);
      break;

    case 'c':
      LogDebug("setting NMR pulser trigger on dio board C, port %i", port);
      nmr_pulser_trg_ = new daq::DioTriggerBoard(0x0, daq::BOARD_C, port);
      break;

    default:
      LogDebug("setting NMR pulser trigger on dio board D, port %i", port);
      nmr_pulser_trg_ = new daq::DioTriggerBoard(0x0, daq::BOARD_D, port);
      break;
  }
  ...
  mux_boards_.push_back(new daq::DioMuxController(0x0, daq::BOARD_A));
  mux_boards_.push_back(new daq::DioMuxController(0x0, daq::BOARD_B));
  mux_boards_.push_back(new daq::DioMuxController(0x0, daq::BOARD_C));
  mux_boards_.push_back(new daq::DioMuxController(0x0, daq::BOARD_D));
