...
#define FRONTEND_NAME "MSCB Ring"
...
EQUIPMENT equipment[] = {
   ...
   {FRONTEND_NAME,                /* equipment name */
    ...
    cd_multi_0,                   /* class driver main routine */
...
//temperature
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+0, "Yoke F Temp 1", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+1, "Yoke F Temp 2", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+2, "Yoke F Temp 3", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+3, "Yoke F Temp 4", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+4, "Temperature 5", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+5, "Temperature 6", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+6, "Temperature 7", 0.01);
  mscb_define("mscb174", FRONTEND_NAME, "SCS2002", mscb_driver, 0x1, TempSlot*8+7, "Temperature 8", 0.01);
