...
//temperature  
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+0, "Temperature 1", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+1, "Temperature 2", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+2, "Temperature 3", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+3, "Temperature 4", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+4, "Temperature 5", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+5, "Temperature 6", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+6, "Temperature 7", 0.01);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, TempSlot*8+7, "Temperature 8", 0.01);
  
  //capacitec
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, ADCSlot*8+0, "Outer Lower", 0.001);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, ADCSlot*8+1, "Inner Upper", 0.001);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, ADCSlot*8+2, "Inner Lower", 0.001);
  mscb_define("mscb110", "Environment", "SCS2001", mscb_driver, 0x1, ADCSlot*8+3, "Outer Upper", 0.001);

  //io currently for laser tracker
  
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+0, "Empty", 1);
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+1, "Laser Set", 1);
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+2, "Laser Reset", 1);
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+3, "Empty", 0.1);
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+4, "Empty", 0.1);
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+5, "Empty", 0.1);
  mscb_define("mscb110", "Environment", "Output", mscb_driver, 0x1, IOSlot*8+6, "Empty", 0.1);
